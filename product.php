				...
				<nav style="--bs-breadcrumb-divider: '>'; font-size:20px;" aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a class="fs-6 text-decoration-none text-black-50" href="#" title="">Home</a>
						</li>
						<li class="breadcrumb-item active" aria-current="page">
							<a class="fs-6 text-decoration-none text-black-50" href="#" title="">Match Kit</a>
						</li>
						<li class="breadcrumb-item active" aria-current="page">
							<a class="fs-6 text-decoration-none text-danger" href="#" title="">Red Authentic Jersey 2024/25</a>
						</li>
					</ol>
				</nav>
			</div>
				...
				<div class="row">
					<div class="col-sm-6 col-12">
						<div class="product-gallery">
							<img class="object-fit-scale" src="./resources/img/latest/latest1.webp" alt="">
						</div>
					</div>
					<div class="col-sm-6 col-12">
						<div class="product-detail">
							<div class="panel-head d-flex flex-column row-gap-3">
								<h1 class="heading-1 fs-3">Red Authentic Jersey 2024/25</h1>
								<div class="product-brand text-black-50 fw-semibold">Brand: <a class="text-orange text-decoration-none" href="" title="">Puma</a></div>
								<div class="product-price">
									<div class="product-price mt-1">
										<div class="d-flex justify-content-start gap-2 align-items-center">
											<span class="price-main fs-4 text-decoration-line-through">
												$245
											</span>
											<span class="price-sale fs-2 fw-medium">
												$221
											</span>
										</div>
									</div>
							...
							<div class="panel-body border-bottom">
								<div class="sold-by fw-semibold">Sold By: <a class="text-orange text-decoration-none" href="" title="">AC.Milan</a></div>
								<div class="description mt-4 pb-5">
									<ul class="d-flex flex-column gap-2">
										<li class="text-orange">
											<span class="text-black-50 text-wrap">Outer material: 100% recycled polyester</span>
										</li>
										<li class="text-orange">
											<span class="text-black-50 text-wrap">Details: 100% polyester</span>
										</li>
										<li class="text-orange">
											<span class="text-black-50 text-wrap">This item was treated individually to give it its unique look. Prints, fabric color, and general appearance may vary.</span>
										</li>
										<li class="text-orange">
											<span class="text-black-50 text-wrap">Always follow the instructions on caring for this garment printed on the inner label to preserve its unique appearance.</span>
										</li>
									</ul>
								</div>
							</div>
							<div class="panel-foot mt-5 border-bottom pb-5">
								<div class="product-action">
									<div class="d-flex flex-lg-row flex-column justify-content-start align-items-lg-center gap-3">
										<div class="quantity-wrapper rounded-pill border position-relative px-1 py-2">
											<button class="change-quantity minus bg-transparent position-absolute top-50 start-0 translate-middle-y fs-4">
												<i class="bi bi-dash"></i>
											</button>
											<input type="text" class="text-center input-quantity w-auto" value="1">
											<button class="change-quantity plus bg-transparent position-absolute top-50 end-0 translate-middle-y fs-4">
												<i class="bi bi-plus"></i>
											</button>
										</div>
										<button class="btn btn-dark rounded-pill px-xxl-5 px-3 py-2" type="button">
											<span><i class="bi bi-cart4"></i></span>
											<span class="ps-2">Add To card</span>
										</button>
										<button class="btn bg-orange rounded-pill text-white px-xxl-5 px-3 py-2 ">Buy Now</button>
									</div>
								</div>
								<div class="compare-wishlist mt-3">
									<div class="d-flex flex-lg-row flex-column align-items-start gap-3">
										<button class="btn fw-semibold">
											<span class="rounded-circle border compare-icon"><i class="bi bi-heart-fill"></i></span>
											<span class="ps-2 compare-title">Add to Wishlist</span>
										</button>

										<button class="btn fw-semibold">
											<span class="rounded-circle border wishlist-icon"><i class="bi bi-arrow-left-right"></i></span>
											<span class="ps-2 wishlist-title">Compare</span>
										</button>
									</div>
								</div>
							</div>
						</div>
						<div class="product-meta mt-5 d-flex flex-column gap-3">
							<div class="meta-item">
								<strong>SKU:</strong> 
								<span class="text-secondary">D2300-3-2</span>
							</div>
							<div class="meta-item">
								<strong>Categories:</strong>
								<a class="text-decoration-none text-orange" href="" title="">Training</a>,
								<a class="text-decoration-none text-orange" href="" title="">Collections</a>,
								<a class="text-decoration-none text-orange" href="" title="">Match kit</a>,
							</div>
							<div class="meta-item">
								<strong>tags:</strong>
								<a class="text-decoration-none text-secondary" href="" title="">Man</a>,
								<a class="text-decoration-none text-secondary" href="" title="">Jersey</a>,
								<a class="text-decoration-none text-secondary" href="" title="">2024/25</a>
							</div>
						</div>
